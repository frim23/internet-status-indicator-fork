// ==WindhawkMod==
// @id              internet-status-indicator-fork
// @name            Internet Status Indicator - Fork (Network Settings/Quick Settings on Click)
// @description     Fork of Internet Status Indicator that adds Quick Settings and Networks Settings on left/right clicks.
// @version         0.7
// @author          ALMAS CP (original), normalized (fork)
// @github          https://github.com/frim23/internet-status-indicator-fork
// @homepage        https://github.com/frim23/internet-status-indicator-fork
// @include         windhawk.exe
// @compilerOptions -lwininet -lws2_32 -liphlpapi -lgdi32 -luser32
// ==/WindhawkMod==

// Forked and modified by normalized
...
// Fork vars
#define ID_MENU_NET_SETTINGS      2001
#define ID_MENU_ADV_NET_SETTINGS  2002
...
private:
    ...
    static void OpenQuickSettingsFallbackWinA() {
        INPUT inputs[4] = {};
        // Win down
    ...
    static void OpenQuickSettings() {
        ...
        HINSTANCE r = ShellExecuteW(nullptr, L"open",
                                L"ms-actioncenter:controlcenter/true",
                                nullptr, nullptr, SW_SHOWNORMAL);

        // ShellExecute returns > 32 on success
        if ((INT_PTR)r <= 32) {
            OpenQuickSettingsFallbackWinA();
        }
    }
    ...
    static void ShowContextMenu(HWND hwnd) {
        ...
        AppendMenuW(hMenu, MF_STRING, ID_MENU_NET_SETTINGS,     L"Network and Internet settings");
        AppendMenuW(hMenu, MF_STRING, ID_MENU_ADV_NET_SETTINGS, L"Advanced network settings");
    ...
    static LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
        ...
        case WM_COMMAND:
            ...
            // Network settings
            case 2001:
                ShellExecuteW(hwnd, L"open", L"ms-settings:network", nullptr, nullptr, SW_SHOWNORMAL);
                return 0;

            // Advanced network settings
            case 2002:
                ShellExecuteW(hwnd, L"open", L"ms-settings:network-advancedsettings", nullptr, nullptr, SW_SHOWNORMAL);
                return 0;
            }
            break;
        }
